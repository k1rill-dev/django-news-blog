...
#     title = forms.CharField(max_length=255, label='Заголовок', widget=forms.TextInput(attrs={'class': 'form_input'})) #виджет - добавление стилей
...
class AddPostForm(forms.ModelForm):
    ...
    def clean_title(self):
        ...
        if len(title) > 200:
            raise ValidationError('Длина заголовка больше 200 символов!')
